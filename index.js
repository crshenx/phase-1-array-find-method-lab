...
// function isWin(teams) {
//   return teams.result === "W";
// }

// console.log(superbowlWin(record));

// function superbowlWin(anArray) {
//   let array = anArray.map((element) => {
//     if (element.result === "W") {
...
// function quiz(artists) {
//   artists.reduce(function (artist) {
//     return artist.startsWith("S");
//   });
// }
// console.log(quiz(artists));

function superbowlWin(array) {
  let outcome = array.find((r) => r.result === "W");
  console.log(outcome);
  // if (!outcome) {
  //   return undefined;
  // }
